...
<header class="header">
    <div class="container">
        ...
        <nav class="nav">
            ...
            <button class="btn btn-close-menu" aria-label="Закрыть меню"></button>
        </nav>
        <div class="menu-right">
            <a href="tel:+77085550848" class="tel text-2xl">+7 708 555 08-48</a>
            <div class="social">
                <a href="https://www.instagram.com/neurorehabkz" target="_blank" aria-label="Переход в инстаграм">
                ...
                <a href="tel:+77085550848" aria-label="Переход в звонок">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button class="btn btn-menu"  aria-label="Закрыть меню"></button>
    </div>
</header>
